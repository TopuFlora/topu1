...
namespace FloraSoft
{
    public class MessageDB
    {
        public void InsertMessage(string BankCode, string MessageFrom, string RoutingNo, string ExpiryDate, string MessageText)
        {
            ...
            SqlCommand myCommand = new SqlCommand("ACH_InsertMessage", myConnection);
        ...
        {
            SqlConnection myConnection = new SqlConnection(AppVariables.ConStr);
            SqlCommand myCommand = new SqlCommand("ACH_GetBranchMessages", myConnection);
            myCommand.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection myConnection = new SqlConnection(AppVariables.ConStr);
            SqlCommand myCommand = new SqlCommand("ACH_GetAllMessages", myConnection);
            myCommand.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlConnection myConnection = new SqlConnection(AppVariables.ConStr);
            SqlCommand myCommand = new SqlCommand("ACH_ExpireMessage", myConnection);
            myCommand.CommandType = CommandType.StoredProcedure;
