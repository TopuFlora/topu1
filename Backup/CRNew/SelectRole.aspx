        ...
        <table align=center>
            ...
            <tr>
                <td class="Normal">
                    Please Select:</td>
                <td style="width: 148px">
                    <asp:DropDownList ID="ddluserrole" runat="server" Width="146px" DataTextField="RoleName" DataValueField="RoleID"></asp:DropDownList></td>
                <td style="width: 100px">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 148px; height: 21px;" align="Right">
                    <asp:LinkButton ID="LoginBtn" runat="server" CssClass="CommandButton" OnClick="Login_Click"
