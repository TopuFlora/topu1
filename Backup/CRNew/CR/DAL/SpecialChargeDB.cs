...
namespace FLoraSoft.CR.DAL
{
    ...
    {
        internal void InsertSpecialCharge(string AccountNumber, int ClearingType, int SCommission, int BankComCont, 
        ...
        internal void UpdateSpecialCharge(int ChargeID, string AccountNumber, int ClearingType, int SCommission,
