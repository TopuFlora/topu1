...
namespace FLoraSoft.CR.DAL
{
    public class StandardChargeDB
    {
        ...
        internal void UpdateStandardCharge(int ChargeID, int Commission, int VAT, int ClearingType,
            string GHO, bool BulkEntry, int STATUS, string UserID)
        {
            SqlConnection myConnection = new SqlConnection(FLoraSoft.CR.DAL.AppVariables.ConStrVVDD);
        ...
        internal void InsertStandardCharge(int Commission, int VAT, int ClearingType, string GHO, bool BulkEntry, int STATUS, 
            string UserID)
        {
            SqlConnection myConnection = new SqlConnection(FLoraSoft.CR.DAL.AppVariables.ConStrVVDD);
