...
namespace FloraSoft.CR
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Request.Cookies["RoleID"].Value == "23")
                {
                    gvSpecialCharge.Columns[11].Visible = false;
                    gvSpecialCharge.Columns[14].Visible = false;
                }
                else if (Request.Cookies["RoleID"].Value == "24")
                {
                    //gvSpecialCharge.Columns[10].Visible = false;
                    gvSpecialCharge.Columns[12].Visible = false;
                    gvSpecialCharge.Columns[13].Visible = false;
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            {
                specialDB.InsertSpecialCharge(txtAccountNumber.Text, Convert.ToInt32(ddlClearingType.SelectedValue), Convert.ToInt32(txtSCommission.Text),
            ...
            {
                specialDB.UpdateSpecialCharge(Convert.ToInt32(hdfChargeID.Value),txtAccountNumber.Text, Convert.ToInt32(ddlClearingType.SelectedValue), Convert.ToInt32(txtSCommission.Text),
                        Convert.ToInt32(txtBankComCont.Text), txtBankComContACNo.Text, Convert.ToInt32(txtSVAT.Text), Convert.ToInt32(txtBankVATCont.Text),
                        txtBankVATContACNo.Text, chkBulkEntry.Checked, 3, Request.Cookies["LoginID"].Value);
                BindData();
                Clear();
                panAdd.Visible = false;
            }
